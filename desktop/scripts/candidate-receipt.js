...
const REALTOR_BETA_RECOVERY_CANDIDATE_VERSION = "1.2.79";
const REALTOR_BETA_RECOVERY_VERSION = "1.2.80";
...
function buildRemotePublishInnerScript({
  ...
  // incident can activate 1.2.80 without any build-machine dependency.
