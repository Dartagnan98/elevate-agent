...
const REALTOR_BETA_RECOVERY_CANDIDATE_VERSION = "1.2.99";
const REALTOR_BETA_RECOVERY_VERSION = "1.2.100";
...
function buildRemotePublishInnerScript({
  ...
  // incident can activate 1.2.100 without any build-machine dependency.
