...
const REALTOR_BETA_RECOVERY_CANDIDATE_VERSION = "1.2.77";
const REALTOR_BETA_RECOVERY_VERSION = "1.2.78";
...
function buildRemotePublishInnerScript({
  ...
  // incident can activate 1.2.78 without any build-machine dependency.
