...
const REALTOR_BETA_RECOVERY_CANDIDATE_VERSION = "1.2.95";
const REALTOR_BETA_RECOVERY_VERSION = "1.2.96";
...
function buildRemotePublishInnerScript({
  ...
  // incident can activate 1.2.96 without any build-machine dependency.
