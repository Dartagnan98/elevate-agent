...
const REALTOR_BETA_RECOVERY_CANDIDATE_VERSION = "1.2.98";
const REALTOR_BETA_RECOVERY_VERSION = "1.2.99";
...
function buildRemotePublishInnerScript({
  ...
  // incident can activate 1.2.99 without any build-machine dependency.
