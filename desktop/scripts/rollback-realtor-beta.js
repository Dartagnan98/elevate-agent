...
const EXPECTED_RECOVERY_VERSION = "1.2.89";
...
// Beta download aliases onto the retained 1.2.89 recovery package. Every
...
function usage() {
  return [
    ...
    "recover lane (roll-forward 1.2.89 activation) takes no other inputs: every",
