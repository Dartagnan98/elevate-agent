...
const EXPECTED_RECOVERY_VERSION = "1.2.105";
...
// Beta download aliases onto the retained 1.2.105 recovery package. Every
...
function usage() {
  return [
    ...
    "recover lane (roll-forward 1.2.105 activation) takes no other inputs: every",
