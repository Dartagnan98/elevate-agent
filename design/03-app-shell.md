# Elevate: App Shell
Main layout, sidebar, routing, nav items.
...
---
## `src/contexts/SystemActions.tsx`
```tsx
...
---
## `src/contexts/page-header-context.ts`
```ts
...
---
## `src/contexts/system-actions-context.ts`
```ts
import { createContext } from "react";
import type { ActionStatusResponse, UpdateStatusResponse } from "@/lib/api";
...
---
## `src/contexts/useSystemActions.ts`
```ts
import { useContext } from "react";
import {
  SystemActionsContext,
