...
| File | What it is |
|---|---|
| `00-feature-map.html` | CRM Feature Map — the full wishlist in 9 sections (Contact cards → On-the-go), each item tagged Built/Partial/New by backend readiness |
...
## Live interactive versions (same mockups — Skyleigh-owned artifacts, only viewable from her account)
- Feature Map (the wishlist / plan): https://claude.ai/code/artifact/ec53734b-5577-419c-81a7-8e5810bb431d — same content as `00-feature-map.html`
