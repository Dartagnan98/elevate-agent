...
DEFAULT_AGENT_DEFS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        **_native_agent_config(
            ...
            core_truths="Social Media owns organic content drafts, short-video direction, and repurposing — hook in the first 3 seconds, build for retention (clickable not clickbait), adapt platform-native, and keep publishing approval-gated. Done means written: content ends as a filed, approval-ready draft — a post idea that lives only in chat is not a deliverable.",
    ...
    },
    {
        ...
        **_native_agent_config(
            ...
            core_truths="Theta Wave improves the fleet through Elevate-native loops, not daemon restarts or PM2 sessions. Done means written: an improvement is not made until the config, skill, or task change is applied and recorded — observations that live only in chat change nothing.",
