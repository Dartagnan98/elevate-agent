...
Usage::
    ...
    elevate profile create coder --clone  # also copy config, .env, SOUL.md
...
def check_alias_collision(name: str) -> Optional[str]:
    ...
    if name in _ELEVATE_SUBCOMMANDS:
        return f"'{name}' conflicts with a elevate subcommand"
...
def set_active_profile(name: str) -> None:
    ...
    if name != "default" and not profile_exists(name):
        raise FileNotFoundError(
            ...
            f"Create it with: elevate profile create {name}"
        )
...
def resolve_profile_env(profile_name: str) -> str:
    ...
    if profile_name != "default" and not profile_dir.is_dir():
        raise FileNotFoundError(
            ...
            f"Create it with: elevate profile create {profile_name}"
        )
