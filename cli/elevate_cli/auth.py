"""
Multi-provider authentication system for Elevate.
...
SPOTIFY_DOCS_URL = "https://github.com/Dartagnan98/elevate-agent/docs/user-guide/features/spotify"
...
def _spotify_interactive_setup(redirect_uri_hint: str) -> str:
    ...
    print("       App name:     anything (e.g. elevate)")
