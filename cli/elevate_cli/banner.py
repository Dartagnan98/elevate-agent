...
Pure display functions with no ElevateCLI state dependency.
"""
...
def check_for_updates() -> Optional[int]:
    ...
    ``~/.elevate/.update_check``).  Returns the number of commits behind,
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    agent_name = _skin_branding("agent_name", "Elevate")
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else ELEVATE_AGENT_LOGO
        console.print(_logo)
        console.print()
