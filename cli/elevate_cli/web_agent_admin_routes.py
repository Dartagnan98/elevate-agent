...
from elevate_cli.web_routes.message_loop import create_message_loop_router
...
from elevate_cli.web_routes.admin_reporting import create_admin_reporting_router
...
def register_agent_admin_routes(
    ...
    *,
    ...
    app.include_router(create_admin_contact_card_router(web_actor=web_actor, log=log))
    ...
    app.include_router(create_message_loop_router(log=log))
    app.include_router(create_admin_pack_router(web_actor=web_actor, log=log))
    app.include_router(create_admin_reporting_router(web_actor=web_actor, log=log))
    app.include_router(
