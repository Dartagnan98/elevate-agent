        ...
        if target.exists():
            if not force:
                console.print(
                    ...
                    f"[bold]elevate plugins update {plugin_name}[/bold] to pull latest."
                )
                sys.exit(1)
...
def _plugin_exists(name: str) -> bool:
    ...
    import elevate_cli
    repo_plugins = _P(elevate_cli.__file__).resolve().parent.parent / "plugins"
...
def _discover_all_plugins() -> list:
    ...
    import elevate_cli
    repo_plugins = Path(elevate_cli.__file__).resolve().parent.parent / "plugins"
