...
TIPS = [
    ...
    # --- Gateway & Messaging ---
    "Elevate runs on 18 platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, email, and more.",
    ...
    "BOOT.md at ~/.elevate/BOOT.md runs automatically on every gateway start — use it for startup checks.",
