...
8. If resuming a task, query the knowledge base: `agent_bus kb-query "<task topic>" --org your org`
9. Check inbox: `agent_bus check-inbox`
10. Update heartbeat: `agent_bus update-heartbeat "online"`
11. Log session start: `agent_bus log-event action session_start info --meta '{"agent":"'your agent name'"}'`
...
- Status: online
- Crons active: <output of `agent_bus list-crons your agent name`>
...
**Add a one-shot reminder:** `agent_bus add-cron your agent name --name <name> --schedule <ISO> --prompt "<text>"` (one-time fire).
