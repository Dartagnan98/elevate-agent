...
## Core Bus Commands
All standard Elevate bus commands apply. See `.claude/skills/bus-reference/SKILL.md` for the full reference.
...
| `agent_bus list-agents --format json` | Audit running agent configurations |
