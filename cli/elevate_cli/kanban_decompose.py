...
Invoked by ``elevate kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Elevate Agent board.
...
def _profile_author() -> str:
    """Mirror of ``elevate_cli.kanban._profile_author``."""
    return (
