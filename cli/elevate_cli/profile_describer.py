...
Used by ``elevate profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Elevate Agent kanban board.
...
Rules:
  ...
  - Never write "Elevate Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_elevate_home())
        else:
