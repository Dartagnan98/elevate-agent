...
def _wire_default_dispatchers() -> None:
    ...
    - social_dm: low-tier-GPT agent dispatcher.
    Disable all with `ELEVATE_SENDER_DISABLE_AGENT` so harnesses keep the stub.
    """
    ...
    if email_mode == "gmail":
        ...
        register_dispatcher("email", _send_agent_dispatch)
    register_dispatcher("social_dm", _send_agent_dispatch)
