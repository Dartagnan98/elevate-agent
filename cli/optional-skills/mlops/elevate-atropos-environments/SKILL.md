---
name: elevate-atropos-environments
description: Build, test, and debug Elevate RL environments for Atropos training. Covers the ElevateAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the elevate repo.
version: 1.1.0
author: Elevate
license: MIT
metadata:
