...
Data file: $ELEVATE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ELEVATE_HOME = Path(os.environ.get("ELEVATE_HOME", Path.home() / ".elevate"))
DATA_DIR = _ELEVATE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
