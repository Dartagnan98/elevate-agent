...
so they don't have to live in plaintext in ``~/.elevate/.env``.
...
* The access token is stored in ``~/.elevate/.env`` as
...
# ---------------------------------------------------------------------------
# Public entry point — called from elevate_cli.env_loader
# ---------------------------------------------------------------------------
