...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - elevate_home (str): The active ELEVATE_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.elevate``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "elevate").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'elevate memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], elevate_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'elevate memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``elevate_home`` is the active ELEVATE_HOME directory path.
