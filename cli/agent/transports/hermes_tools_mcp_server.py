...
This module exposes a curated subset of those /tools to the
...
EXPOSED_TOOLS: tuple[str, ...] = (
    ...
    "skills_list",
    "text_to_speech",
    # Kanban worker handoff tools — gated on ELEVATE_KANBAN_TASK env var
    # (set by the kanban dispatcher when spawning a worker). Without these
    # in the callback, a worker spawned with openai_runtime=codex_app_server
    # could do the work but couldn't report completion back to the kernel,
    # making it hang until timeout. Stateless dispatch — they just read
    # the env var and write to ~/.elevate/kanban.db.
    "kanban_complete",
    "kanban_block",
    "kanban_comment",
    "kanban_heartbeat",
...
def _build_server() -> Any:
    """Create the FastMCP server with /tools attached. Lazy imports
    ...
    # Discover /tools so dispatch works.
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    os.environ.setdefault("ELEVATE_QUIET", "1")
    os.environ.setdefault("ELEVATE_REDACT_SECRETS", "true")
