...
def auth_json_path():
    """Return the Elevate auth store path, respecting ELEVATE_HOME overrides."""
    return get_elevate_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from elevate_cli.auth import resolve_nous_access_token
