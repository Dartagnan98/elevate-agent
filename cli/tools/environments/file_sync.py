...
def iter_sync_files(container_base: str = "/root/.elevate") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.elevate to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``ELEVATE_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, elevate_home: Path | None = None) -> None:
        ...
        lock_path = (elevate_home or get_elevate_home()) / ".sync.lock"
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.elevate/skills/a.md`` →
        ``~/.elevate/skills/a.md``, a new remote file at
        ``/root/.elevate/skills/b.md`` maps to ``~/.elevate/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
        for host, remote in mapping:
