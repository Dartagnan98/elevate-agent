...
`mcp_tool.py`, and `elevate_cli/mcp_config.py`. This module is the ONLY place
...
def _make_elevate_provider_class() -> Optional[type]:
    ...
    class ElevateMCPOAuthProvider(OAuthClientProvider):
        ...
        def __init__(self, *args: Any, server_name: str = "", **kwargs: Any):
            ...
            self._elevate_server_name = server_name
        ...
        async def _initialize(self) -> None:
            ...
            Paired with :class:`ElevateTokenStorage` persisting an absolute
                ...
                for url in build_protected_resource_metadata_discovery_urls(
                    ...
                    try:
                        ...
                        logger.debug(
                            ...
                            self._elevate_server_name, url, exc,
                        )
                        continue
...
_ELEVATE_PROVIDER_CLS: Optional[type] = _make_elevate_provider_class()
...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        Returns None if the MCP SDK's OAuth support is unavailable.
        """
        if _ELEVATE_PROVIDER_CLS is None:
            logger.warning(
        ...
        storage = ElevateTokenStorage(server_name)
