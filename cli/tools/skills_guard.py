...
Trust levels:
  - builtin:   Ships with Elevate. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.elevate/\.env|\~/\.elevate/\.env',
     "elevate_env_access", "critical", "exfiltration",
     "directly references Elevate secrets file"),
    ...
    (r'\.elevate/config\.yaml|\.elevate/SOUL\.md',
     "elevate_config_mod", "critical", "persistence",
     "references Elevate configuration files directly"),
