...
ALL elevate tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all elevate tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/_elevate_upload.b64"
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("ELEVATE_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("ELEVATE_QUIET", None)
            else:
                os.environ["ELEVATE_QUIET"] = _prev_quiet
