"""
ElevateSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
class ElevateSweEnv(ElevateAgentBaseEnv):
    ...
    name = "elevate-swe"
    env_config_cls = ElevateSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[ElevateSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = ElevateSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepElevate-3-Llama-3-3B-Preview",
            tool_call_parser="elevate",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="elevate-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepElevate-3-Llama-3-3B-Preview",
