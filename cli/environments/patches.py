"""
Monkey patches for making elevate tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by elevate_base_env.py).
