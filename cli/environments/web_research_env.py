...
Inspired by: GroceryMind — production Elevate agent doing live web research
             across German grocery stores (firecrawl + elevate)
"""
...
# Ensure elevate root is on path
...
class WebResearchEnvConfig(ElevateAgentEnvConfig):
...
class WebResearchEnv(ElevateAgentBaseEnv):
    """
