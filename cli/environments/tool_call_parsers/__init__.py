...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("elevate")
        class ElevateToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "elevate", "mistral", "llama3_json")
...
from environments.tool_call_parsers.elevate_parser import ElevateToolCallParser  # noqa: E402, F401
