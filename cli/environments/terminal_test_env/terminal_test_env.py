...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Elevate"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Elevate",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Elevate",
    },
    {
...
class TerminalTestEnv(ElevateAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/elevate/.env.
        """
