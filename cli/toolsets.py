...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Elevate toolsets (CLI + messaging platforms)
    #
    ...
    "elevate-cron": {
        # Mirrors elevate-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `elevate tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant, rl) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as elevate-cli; gated by `elevate tools`",
        "tools": _ELEVATE_CORE_TOOLS,
        "includes": []
    },
    ...
    "elevate-email": {
        "description": "Email bot toolset - interact with Elevate via email (IMAP/SMTP)",
        "tools": _ELEVATE_CORE_TOOLS,
        "includes": []
    },
    ...
    "elevate-sms": {
        "description": "SMS bot toolset - interact with Elevate via SMS (Twilio)",
        "tools": _ELEVATE_CORE_TOOLS,
        "includes": []
    },
    ...
    "elevate-gateway": {
        ...
        "tools": [],
        "includes": ["elevate-telegram", "elevate-discord", "elevate-whatsapp", "elevate-slack", "elevate-signal", "elevate-bluebubbles", "elevate-homeassistant", "elevate-email", "elevate-sms", "elevate-mattermost", "elevate-matrix", "elevate-dingtalk", "elevate-feishu", "elevate-wecom", "elevate-wecom-callback", "elevate-weixin", "elevate-qqbot", "elevate-webhook"]
    }
}
