...
Indexes are intentionally limited to the first API shapes: kanban grouping by `side/current_stage/status`, contact drill-in, recent updates, and event-log reads by deal/kind/field. The first migration should defer `pending_items` and `conditional_docs`, which the plan attaches to later toggle-driven dispatch (`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:149`), dispatcher run ids and action execution wiring (`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:180`-`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:188`), Outputs-tab artifact linkage (`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:202`-`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:206`), province guide/reference tables (`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:165`-`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:170`), and SkySlope read/write adapter state (`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:224`-`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:225`). Phase A's exit criteria are just persisted card moves across browsers and province-swapped checklist content (`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:157`-`/Users/dartagnanpatricio/elevate/cli/docs/plans/skyleigh-admin-hub-agentic-workflow-plan.md:173`), so stricter enum value checks can also wait until the source values are named.
