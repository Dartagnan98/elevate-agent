...
| --- | --- | --- | --- | --- | --- | --- |
| todo | P1 | `/agent-hub` | `AgentHubPage.tsx` HarnessCard | 7 MiniMetric tiles (Clients/Routed/Events/Ready Runs/Blocked/Safety/Memory Flow) are technical noise; realtor cannot act on these | Collapse to 3 operator-facing tiles (Ready / Blocked / Safety status) or hide behind a Details disclosure | tsc + vite + visual |
