...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Elevate\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "cursoelevate@cursor.com",
    "elevate@nousresearch.com",
    "elevate-audit@example.com",
    "elevate@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "Dartagnan98/elevate-agent",
                "--state", "merged",
