...
DEFAULT_DATASETS = [
    ...
    "NousResearch/elevate-megascience-sft1",
    "NousResearch/Elevate-Thinking-GLM-4.7-SFT2",
    "NousResearch/Elevate-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-elevate"
]
