#!/usr/bin/env python3
"""Build the Elevate Skills Index — a centralized JSON catalog of all skills.
...
`elevate skills search/install` can use it without hitting the GitHub API.
...
# Ensure ELEVATE_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("ELEVATE_HOME", os.path.join(os.path.expanduser("~"), ".elevate"))
...
def main():
    print("Building Elevate Skills Index...", flush=True)
