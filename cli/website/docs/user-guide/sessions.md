...
When a session's context is compressed (manually via `/compact` or automatically), Elevate creates a new continuation session. If the original had a title, the new session automatically gets a numbered title:
