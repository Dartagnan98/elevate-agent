...
Control the user's Spotify account via the Elevate Spotify toolset (7 tools). Setup guide: https://elevate.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `elevate auth spotify` again.
