...
```python
import sys
sys.path.insert(0, "/home/teknium/.elevate/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.elevate/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Elevate installs package this)
