...
| | |
|---|---|
| Source | Optional — install with `elevate skills install official/research/qmd` |
...
Elevate via the native MCP client. This is the preferred
...
Then configure Elevate to connect via HTTP:
