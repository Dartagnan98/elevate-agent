...
| | |
|---|---|
| Source | Optional — install with `elevate skills install official/health/neuroskill-bci` |
...
Connect Elevate to a running [NeuroSkill](https://neuroskill.com/) instance to read
