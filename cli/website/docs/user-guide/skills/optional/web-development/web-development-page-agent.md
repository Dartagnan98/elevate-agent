...
- User wants **Elevate itself to drive a browser** → use Elevate' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
