#!/usr/bin/env python3
"""
SWE Runner with Elevate Trajectory Format

A runner that uses Elevate's built-in execution environments
(local, docker, modal) and outputs trajectories in the Elevate format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Elevate's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Elevate format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Elevate format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Elevate's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Elevate Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Elevate's built-in execution environments
    and outputs trajectories in Elevate format.
    """
    ...
    def _convert_to_elevate_format(
        self,
        ...
        """
        Convert internal message format to Elevate trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Elevate trajectory format
        trajectory = self._convert_to_elevate_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Elevate trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Elevate Trajectory Format")
    print("=" * 60)
