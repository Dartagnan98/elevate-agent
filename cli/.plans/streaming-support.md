# Streaming LLM Response Support for Elevate
...
```
ELEVATE_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ELEVATE_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `elevate_cli/config.py` | 1 | +streaming config defaults |
...
ELEVATE_STREAMING_ENABLED=true
```
