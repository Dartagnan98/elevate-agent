...
export function MemoryConstellation({
  ...
  const graphStyle = {
    ...
    // Entity / project / community / user / plaud tones key off --color-primary
    // so the page's entity-hue swatch re-tints the graph live; structural and
    // neutral tones stay on the prototype's cool silver palette.
    "--memory-node-entity": "color-mix(in srgb, var(--color-primary) 70%, #CBD0DE)",
    "--memory-node-entity-fill": "color-mix(in srgb, var(--color-primary) 58%, #9AA0AE)",
    "--memory-node-entity-halo": "color-mix(in srgb, var(--color-primary) 26%, transparent)",
    ...
    "--memory-node-community": "color-mix(in srgb, var(--color-primary) 55%, #D8DBE2)",
    "--memory-node-community-fill": "color-mix(in srgb, var(--color-primary) 42%, #A6ABB8)",
    "--memory-node-community-halo": "color-mix(in srgb, var(--color-primary) 24%, transparent)",
    "--memory-node-project": "color-mix(in srgb, var(--color-primary) 60%, #CBD0DE)",
    "--memory-node-project-fill": "color-mix(in srgb, var(--color-primary) 46%, #9AA0AE)",
    "--memory-node-project-halo": "color-mix(in srgb, var(--color-primary) 22%, transparent)",
