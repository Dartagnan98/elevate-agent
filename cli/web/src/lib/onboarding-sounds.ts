...
/**
 * Onboarding whoosh — plays `/sounds/onboarding-whoosh.wav` (Foundation
 * Ocular Whooshes – "Dark Air"). Wired only to Start onboarding and
 * Re-run onboarding clicks. Plays once at its natural length.
 */
