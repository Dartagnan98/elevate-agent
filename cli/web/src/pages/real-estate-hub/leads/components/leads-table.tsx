          ...
          <div className="leadsx-sb-more" ref={moreRef}>
            ...
            {openMenu === "more" && (
              <div className="leadsx-moremenu">
                ...
                <div className="sep" />
                <button className="soon" disabled title="Direct mail is not available yet."><span className="ic">✉</span>Send Postcards<span className="tagsoon">soon</span></button>
                <button className="soon" disabled title="Direct mail is not available yet."><span className="ic">📄</span>Send Letters<span className="tagsoon">soon</span></button>
              </div>
            )}
          </div>
      ...
      {filtered.length > PAGE && (
        <div className="leadsx-pager">
          ...
          <div className="nums">
            ...
            <button className="on" disabled aria-current="page">{safePage + 1}</button>
