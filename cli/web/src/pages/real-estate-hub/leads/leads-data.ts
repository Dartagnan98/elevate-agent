...
export const LEADS_DRAFTS: LeadsDraft[] = [
  { id: "d1", name: "Randi DeGagne", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Randi! It's Skyleigh from EXP Realty :) Saw you were looking at homes on my website. I'd hate to be one of those spam-y agents bombarding you with stuff that totally misses the mark haha. What areas have been catching your eye?", heat: "warm" },
  { id: "d2", name: "Christina Montgomery", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Christina! It's Skyleigh from EXP Realty :) Saw you were looking at homes on my website. I'd hate to be one of those spam-y agents bombarding you with stuff that totally misses the mark haha. What areas have been catching your eye?", heat: "warm" },
  { id: "d3", name: "Tara Bourassa", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Tara! It's Skyleigh from EXP Realty :) Saw you were looking at one of my listings on my website. Because it's my listing, I always like to ask first if you're already working with an agent. Are you represented already, or just casually browsing right now?", heat: "hot" },
  { id: "d4", name: "Nataly Michel Cuello Valdez", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Nataly! It's Skyleigh from EXP Realty :) Saw you were looking at homes on my website. I'd hate to be one of those spam-y agents bombarding you with stuff that totally misses the mark haha. What areas have been catching your eye?", heat: "warm" },
  { id: "d5", name: "Judy Hunt", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Judy! It's Skyleigh from EXP Realty :) I saw your name come through my system around a property search, but I don't want to assume what you're after. Are you searching Kamloops, the Okanagan, or somewhere else?", heat: "warm" },
  { id: "d6", name: "Hannah & Bill", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Hannah! It's Skyleigh from EXP Realty :) I saw your name come through my system around a property search, but I don't want to assume what you're after. Are you searching Kamloops, the Okanagan, or somewhere else?", heat: "warm" },
  { id: "d7", name: "Elle", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Elle! It's Skyleigh from EXP Realty :) Saw you were looking at homes on my website. I'd hate to be one of those spam-y agents bombarding you with stuff that totally misses the mark haha. What areas have been catching your eye?", heat: "warm" },
  { id: "d8", name: "Karen Polson", source: "Lofty CRM", channel: "SMS", age: "4h", body: "Hi Karen! It's Skyleigh from EXP Realty :) Saw you were looking at homes on my website. I'd hate to be one of those spam-y agents bombarding you with stuff that totally misses the mark haha. What areas have been catching your eye?", heat: "warm" },
];
...
export const LEADS_PROFILES: LeadsProfile[] = [
  { id: "p1", name: "Carol Chen", heat: 100, group: "active", verified: true, status: "Follow Up", source: "Lofty CRM", email: "shanshan8321@gmail.com", phone: "(250) 555-0142", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "Carol Chen from Lofty is in Active Lead via Other.", lastMsg: "Hi Skyleigh — saw your listing, can we book a viewing this week?", lastTouch: "7m ago" },
  { id: "p2", name: "Norm Carter", heat: 100, group: "active", verified: true, status: "Follow Up", source: "Lofty CRM", email: "normcarter10@gmail.com", phone: "(250) 555-0188", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "Norm Carter from Lofty is in Active Lead via Other.", lastMsg: "Got the showing time, see you at 2.", lastTouch: "7m ago" },
  { id: "p3", name: "Cal Carson", heat: 87, group: "active", verified: true, status: "New Lead", source: "Lofty CRM", email: "cal.carson1965@gmail.com", phone: "(250) 555-0211", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "Cal Carson from Lofty is in New Leads via Other.", lastMsg: "Hey — what's pricing like in Sahali?", lastTouch: "7m ago" },
  { id: "p4", name: "David Carswell", heat: 87, group: "active", verified: true, status: "New Lead", source: "Lofty CRM", email: "carsey50@gmail.com", phone: "(250) 555-0277", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "David Carswell from Lofty is in New Leads via Other.", lastMsg: "Interested in the Greenfield place. Any open houses?", lastTouch: "7m ago" },
  { id: "p5", name: "David Chestin", heat: 87, group: "active", verified: true, status: "New Lead", source: "Lofty CRM", email: "pjanes@telus.net", phone: "(250) 555-0319", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "David Chestin from Lofty is in New Leads via Other.", lastMsg: "Are you still showing the unit on Nicola?", lastTouch: "7m ago" },
  { id: "p6", name: "Mindy Caruso", heat: 87, group: "active", verified: true, status: "New Lead", source: "Lofty CRM", email: "mindy8@telus.net", phone: "(778) 555-0356", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "Mindy Caruso from Lofty is in New Leads via Other.", lastMsg: "Quick q on the property tax — does it include strata?", lastTouch: "7m ago" },
  { id: "p7", name: "Tracy Carver", heat: 87, group: "active", verified: true, status: "New Lead", source: "Lofty CRM", email: "tracy@techbits.ca", phone: "(778) 555-0421", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "Tracy Carver from Lofty is in New Leads via Other.", lastMsg: "Just texted my partner, will get back tonight.", lastTouch: "7m ago" },
  { id: "p8", name: "Wayne Chorneychuk", heat: 69, group: "active", verified: true, status: "New Lead", source: "Lofty CRM", email: "waynechoreney@gmail.com", phone: "(250) 555-0468", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "Wayne Chorneychuk from Lofty is in New Leads via Other.", lastMsg: "Sorry for the slow reply — interested in townhomes.", lastTouch: "7m ago" },
  { id: "p9", name: "Bonnie Gerrior", heat: 100, group: "active", verified: true, status: "Follow Up", source: "Lofty CRM", email: "heartnsoul60@gmail.com", phone: "(250) 555-0509", contact: "DB contact", threads: 1, age: "7m ago", tags: ["CRM-LEAD","LOFTY-CRM","XPOSURE-PCS"], sub: "Bonnie Gerrior from Lofty is in Active Lead via Other.", lastMsg: "Yes still in the market, what's new in West End?", lastTouch: "7m ago" },
  { id: "p10", name: "Marcus Greene", heat: 60, group: "verified", verified: true, status: "Follow Up", source: "Composio", email: "mgreene@gmail.com", phone: "(604) 555-0612", contact: "Web form", threads: 0, age: "2d ago", tags: ["BUYER","COMPOSIO-IG"], sub: "Marcus Greene from Composio is queued for buyer workflow.", lastMsg: "Verified by phone, ready for the buyer fit call.", lastTouch: "2d ago" },
  { id: "p11", name: "Linda Hayworth", heat: 55, group: "verified", verified: true, status: "Follow Up", source: "Lofty CRM", email: "linda.h@telus.net", phone: "(250) 555-0673", contact: "DB contact", threads: 0, age: "3d ago", tags: ["SELLER","LOFTY-CRM"], sub: "Linda Hayworth is verified and ready for seller CMA.", lastMsg: "Confirmed — CMA next week works.", lastTouch: "3d ago" },
  { id: "p12", name: "Priya Devi", heat: 72, group: "verified", verified: true, status: "Follow Up", source: "Lofty CRM", email: "priya.devi@outlook.com", phone: "(250) 555-0734", contact: "DB contact", threads: 0, age: "4d ago", tags: ["BUYER","LOFTY-CRM"], sub: "Priya Devi verified, awaiting buyer fit call.", lastMsg: "Buyer profile filled in, send me listings.", lastTouch: "4d ago" },
  { id: "p13", name: "Tanner", heat: 45, group: "unverified", verified: false, status: "New Lead", source: "Composio", email: "tanner91@gmail.com", phone: "(236) 555-0801", contact: "IG DM", threads: 1, age: "1d ago", tags: ["COMPOSIO-IG"], sub: "Tanner reached out via Instagram DM — needs verification.", lastMsg: "Hey, saw your reel about the West End townhomes.", lastTouch: "1d ago" },
  { id: "p14", name: "Robin Daniel", heat: 38, group: "unverified", verified: false, status: "New Lead", source: "Composio", email: "robin.daniel.r@gmail.com", phone: "(778) 555-0884", contact: "IG DM", threads: 1, age: "2d ago", tags: ["COMPOSIO-IG"], sub: "Robin Daniel via Instagram — verify before workflow.", lastMsg: "DM from IG — looking for a 2BR around Brock.", lastTouch: "2d ago" },
];
...
export const LEADS_SENT: LeadsSentMessage[] = [
  ...
  { id: "sm3", when: "5/14/2026, 11:09:08 PM", recipient: "Dartagnan (native dispatcher test) · +17788714535", source: "apple-messages", transport: "IMESSAGE", message: "elevate native dispatcher live — if you got this, /leads can send", msgId: "imessage-d2b74dbaf1", status: "sent" },
  { id: "sm4", when: "5/14/2026, 10:56:01 PM", recipient: "test-dartagnan-imessage-001", source: "apple-messages", transport: "STUB", message: "yo this is a test from elevate — if you got this the send pipeline is live", msgId: "stub-sms-67aede9f362e", status: "sent" },
