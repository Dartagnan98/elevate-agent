...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_elevate_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/elevate")
            async def handle_elevate_command(ack, command):
                await ack()
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own Elevate session — matching the per-thread behavior channels already
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "elevate_approve_once": "once",
            "elevate_approve_session": "session",
            "elevate_approve_always": "always",
            "elevate_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from elevate_cli.commands import slack_subcommand_map
