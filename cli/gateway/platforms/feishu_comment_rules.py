...
Config: ~/.elevate/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.elevate/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_elevate_home()`` helper (ELEVATE_HOME-aware and
...
RULES_FILE = get_elevate_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_elevate_home() / "feishu_comment_pairing.json"
