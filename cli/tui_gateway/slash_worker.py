"""Persistent slash-command worker — one ElevateCLI per TUI session.
...
def _run(cli: ElevateCLI, command: str) -> str:
...
def main():
    ...
    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
        cli = ElevateCLI(model=args.model or None, compact=True, resume=args.session_key, verbose=False)
