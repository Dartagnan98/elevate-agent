...
def _profile_user_agent() -> str:
    """Return a ``elevate-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from elevate_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"elevate-cli/{_ver}"
    except Exception:
        return "elevate-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # elevate-cli UA so the catalog endpoint is reachable.
