...
2. User plugins: ``$ELEVATE_HOME/plugins/model-providers/<name>/``
...
def register_provider(profile: ProviderProfile) -> None:
    ...
    plugins under ``$ELEVATE_HOME/plugins/model-providers/`` can override
...
def _user_plugins_dir() -> Path | None:
    """Return ``$ELEVATE_HOME/plugins/model-providers/`` if it exists."""
    try:
        from elevate_constants import get_elevate_home

        d = get_elevate_home() / "plugins" / "model-providers"
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    # multiple ELEVATE_HOME profiles don't alias each other.
...
def _discover_providers() -> None:
    ...
    Order:
      ...
      2. User plugins at ``$ELEVATE_HOME/plugins/model-providers/<name>/``
    ...
    # 2. User plugins — under $ELEVATE_HOME/plugins/model-providers/<name>/.
