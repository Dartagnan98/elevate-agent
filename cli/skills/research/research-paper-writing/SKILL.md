...
Section-by-section drafting playbook: abstract, intro, related work, method, experiments, results, discussion, conclusion, plus title/figure/table craft.

Full playbook: `skill_view(name="research-paper-writing", file_path="references/phase-5-paper-drafting.md")`
...
Submission mechanics: formatting compliance, anonymization, supplementary material, artifact release, OpenReview/CMT upload, and the rebuttal cycle.

Full playbook: `skill_view(name="research-paper-writing", file_path="references/phase-7-submission.md")`
...
| Document | Contents |
|----------|----------|
| [references/phase-5-paper-drafting.md](references/phase-5-paper-drafting.md) | Phase 5 in full: section-by-section drafting, title/abstract craft, figures and tables |
| [references/phase-7-submission.md](references/phase-7-submission.md) | Phase 7 in full: formatting compliance, anonymization, artifact release, rebuttal cycle |
