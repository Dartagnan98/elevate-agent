---
name: ascii-video
description: "Render colored ASCII-character video (MP4/GIF/frames) from video, audio, images, or code. Use when the user wants 'ASCII video', 'convert video to ASCII', a 'terminal-style' or 'matrix-style' clip, an 'ASCII audio visualizer', or any animated character-art output. Not for a single static ASCII banner or logo — use ascii-art; not for retro pixel-art frames — use pixel-art."
---
