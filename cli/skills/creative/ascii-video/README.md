...
Built for [Elevate](https://github.com/Dartagnan98/elevate-agent). Usable in any coding agent. Canonical source lives here; synced to [`Dartagnan98/elevate-agent/skills/creative/ascii-video`](https://github.com/Dartagnan98/elevate-agent/tree/main/skills/creative/ascii-video) via PR.
