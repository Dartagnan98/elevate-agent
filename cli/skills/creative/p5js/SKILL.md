---
name: p5js
description: "Build interactive/generative browser visual art with p5.js. Use when the user wants a 'p5.js sketch', 'creative coding', 'generative art', a 'canvas animation', 'shader effects', or an audio-reactive/interactive visual — exported as HTML, PNG, GIF, MP4, or SVG. Not for math explainer videos — use manim-video; not for ASCII-character video — use ascii-video."
version: 1.0.0
metadata:
  elevate:
