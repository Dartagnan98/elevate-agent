---
name: xurl
description: "Interact with X/Twitter via xurl, the official X API CLI. Use when the user wants to post, reply, quote, search, read timelines or mentions, like, repost, bookmark, follow, DM, upload media on X, or hit a raw v2 endpoint. Not for planning or scheduling a real-estate content calendar — use social-content-engine; not for other social networks. Replaces the older xitter skill; OAuth 2.0 PKCE with auto-refresh, JSON to stdout."
version: 1.1.1
author: xdevplatform + openclaw + Elevate
license: MIT
...
- Elevate adaptation: reformatted for Elevate skill conventions; safety guardrails preserved verbatim.
