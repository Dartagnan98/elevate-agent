...
description: "Fine-tune LLMs with TRL's Python trainers — SFT, DPO, PPO/GRPO, reward models. Use when 'do RLHF', 'align with DPO', instruction-tuning via SFTTrainer, or training from human preferences. Works with HuggingFace Transformers. Not for YAML-driven multi-recipe runs — use axolotl; not for fastest single-GPU LoRA — use unsloth."
version: 1.0.0
