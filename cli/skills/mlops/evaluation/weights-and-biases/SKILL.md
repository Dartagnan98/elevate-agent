...
description: "Track ML experiments, live training curves, sweeps, and model registry with W&B. Use when 'log to wandb', 'track my training run', comparing runs, launching a hyperparameter sweep, or versioning models/datasets. Not for scoring model quality on benchmarks — use evaluating-llms-harness. Collaborative MLOps platform; needs a wandb account."
version: 1.0.0
