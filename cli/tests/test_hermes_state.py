"""Tests for elevate_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSchemaInit:
    ...
    def test_migration_from_v2(self, tmp_path):
        ...
        # Verify turn_usage table was added for per-turn analytics
        cursor = migrated_db._conn.execute(
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import sqlite3
        import inspect
        from elevate_state import SessionDB as _SessionDB
