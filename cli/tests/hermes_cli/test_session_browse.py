"""Tests for the interactive session browser (`elevate sessions browse`).
...
from elevate_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """elevate sessions browse should be parseable."""
        from elevate_cli.main import main as _main_entry
