...
class TestXiaomiAliases:
    ...
    def test_normalize_provider_models_py(self):
        from elevate_cli.models import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"

    def test_normalize_provider_providers_py(self):
        from elevate_cli.providers import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from elevate_cli.model_normalize import _VENDOR_PREFIXES
    ...
    def test_matching_prefix_strip(self):
        ...
        from elevate_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_lowercase_model_provider(self):
        ...
        from elevate_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ELEVATE_OVERLAYS
        overlay = ELEVATE_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify elevate doctor recognizes Xiaomi env vars."""

    def test_provider_env_hints(self):
        from elevate_cli.doctor import _PROVIDER_ENV_HINTS
...
class TestXiaomiAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from elevate_cli.providers import ELEVATE_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = ELEVATE_OVERLAYS["xiaomi"]
