...
def _reload_constants():
    """Reload elevate_constants to get a fresh apply_ipv4_preference."""
    import elevate_constants
    importlib.reload(elevate_constants)
    return elevate_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_elevate_ipv4_patched", False) is True
