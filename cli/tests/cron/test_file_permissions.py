...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("elevate_cli.config.get_config_path", return_value=config_path), \
             patch("elevate_cli.config.ensure_elevate_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("elevate_cli.config.get_env_path", return_value=env_path), \
             patch("elevate_cli.config.ensure_elevate_home"):
