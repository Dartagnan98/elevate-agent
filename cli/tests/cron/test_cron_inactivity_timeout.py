...
- Unlimited timeout (ELEVATE_CRON_TIMEOUT=0)
- Backward compat: ELEVATE_CRON_TIMEOUT env var still works
...
class TestInactivityTimeout:
    ...
    def test_unlimited_timeout(self):
        """ELEVATE_CRON_TIMEOUT=0 means no timeout at all."""
        agent = FakeAgent(idle_seconds=0.0)
...
class TestSysPathOrdering:
    ...
    def test_elevate_constants_importable(self):
        ...
        assert callable(get_elevate_home)
