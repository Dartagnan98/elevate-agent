...
def _enable_managed_nous_tools(monkeypatch):
    ...
    elevate_cli.auth and elevate_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("elevate_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("elevate_cli.models.check_nous_free_tier", lambda: False)
