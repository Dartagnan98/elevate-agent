...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_elevate_home_override(self, tmp_path):
        """Auth lookup should read from ELEVATE_HOME/auth.json, not ~/.elevate/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".elevate").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``elevate tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
