...
class TestParserRegistry:
    ...
    def test_elevate_parser_registered(self):
        parsers = list_parsers()
        assert "elevate" in parsers
...
# ─── Elevate parser tests ────────────────────────────────────────────────

class TestElevateParser:
    @pytest.fixture
    def parser(self):
        return get_parser("elevate")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["elevate"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use elevate format since that's universal
