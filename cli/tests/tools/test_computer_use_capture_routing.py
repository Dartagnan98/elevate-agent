...
* ``elevate_constants.get_elevate_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_elevate_dir so cache writes land under tmp_path."""
    ...
    with patch("elevate_constants.get_elevate_dir", _fake_get):
        yield cache_dir
...
class TestRoutingDecisionWiring:
    ...
    def test_config_load_failure_disables_routing_safely(self):
        ...
        with patch("elevate_cli.config.load_config",
