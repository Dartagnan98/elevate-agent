...
class TestCronjobRequirements:
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("ELEVATE_GATEWAY_SESSION", "1")
        monkeypatch.delenv("ELEVATE_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("ELEVATE_INTERACTIVE", raising=False)
        monkeypatch.delenv("ELEVATE_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("ELEVATE_EXEC_ASK", "1")
    ...
    def test_rejects_false_like_interactive_env(self, monkeypatch, false_like_value):
        monkeypatch.setenv("ELEVATE_INTERACTIVE", false_like_value)
        monkeypatch.delenv("ELEVATE_GATEWAY_SESSION", raising=False)
        monkeypatch.delenv("ELEVATE_EXEC_ASK", raising=False)
        assert check_cronjob_requirements() is False
    ...
    @pytest.mark.parametrize(
        "var_name",
        ["ELEVATE_INTERACTIVE", "ELEVATE_GATEWAY_SESSION", "ELEVATE_EXEC_ASK"],
    )
    @pytest.mark.parametrize("false_like_value", ["0", "false", "no", "off"])
    def test_rejects_false_like_any_session_env(
        ...
        for v in ("ELEVATE_INTERACTIVE", "ELEVATE_GATEWAY_SESSION", "ELEVATE_EXEC_ASK"):
