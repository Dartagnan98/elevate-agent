...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @elevate_bot", entities=[_mention_entity("hi @elevate_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message("/status@elevate_bot", entities=[_mention_entity("/status@elevate_bot")])
    ) is True
