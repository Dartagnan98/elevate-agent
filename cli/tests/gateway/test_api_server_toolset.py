"""Tests for elevate-api-server toolset and API server tool availability."""
import os
import json
...
class TestElevateApiServerToolset:
    """Tests for the elevate-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("elevate-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("elevate-api-server")

    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("elevate-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "elevate-api-server"
...
class TestApiServerAdapterToolset:
    ...
    def test_create_agent_reads_config_toolsets(self):
        ...
        with patch("gateway.run._resolve_runtime_agent_kwargs") as mock_kwargs, \
            ...
            # No platform_toolsets override — should fall back to elevate-api-server default
